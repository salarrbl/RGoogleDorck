...
dorks = [
    ...
    'intitle:"student login"',
    'intitle:"teacher login"',
    ...
    'intitle:"account login"',
    'intitle:"access control"',
    'intitle:"admin area"',
    'intitle:"user authentication"',
    'intitle:"sign in to your account"',
    'intitle:"portal"',
    'intitle:"dashboard"'
]
user_agent = [
